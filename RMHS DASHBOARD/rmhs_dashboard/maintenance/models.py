...
class MaintenanceActivity(models.Model):
    ...
    spares_used = models.TextField(blank=True, null=True, help_text="Spares used for maintenance")
    ...
    def __str__(self):
        return f"{self.maintenance_type} Maintenance - {self.date} - {self.equipment}"
